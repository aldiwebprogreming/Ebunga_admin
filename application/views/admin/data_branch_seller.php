                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else { ?>
                                                       ...
                                                       <a id="status" href="<?= base_url() ?>branch_seller/status_branch_seller?id=<?= $data['id'] ?>" class="badge rounded-pill btn btn-danger" onclick="return confirm('Apakah ingin mengaktifkan branch seller ini ?')"><?= $data['status_branch'] ?></a>
                                                     <?php } ?>
                                                 </td>
                                                <td>

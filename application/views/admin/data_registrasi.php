      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1><i class="fas fa-sign-in-alt" style="font-size: 20px;"></i> <?= $sub_title; ?></h1>
          </div>
                  ...
                  <div class="card-header">
                    <h4><?= $sub_title ?></h4>
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?= base_url() ?>registrasi_user/tambah_registrasi" class ="btn btn-primary mb-4"> Tambah Registrasi</a> 

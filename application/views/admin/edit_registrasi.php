                        ...
                        <div class="col-md-8 col-lg-8">
                            ...
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                              ...
                              <small><?= $data['waktu_registrasi'] ?></small>
                            </div>
                             ...
                             <div class="mb-3">
                              ...
                              <input type="datetime-local" class="form-control" name="waktu_aktivasi"    value="<?= $data['waktu_aktivasi'] ?>">
                              <small><?= $data['waktu_aktivasi'] ?></small>
                            </div>
